...
Editing: I have been able to change the primary colour of the hyperlinks from Red to Blue, edited the social media links, decreasing it from three (3) to two (2), and placing my details in there. I also added a 'Contact' page which was surprisingly easy.

Once I realised that the NavMenu entries are added to the 'config.yaml' and not an '/../assets/navigation.html' arrangement. Having core definitions in a 'config.yaml/.toml' is an efficient method, given these assignments are not changed often.
