...
While waiting for a reply, on spec, I rm'd -f R-Base, then reinstalling it but there does not seem to be any change. I will do some more reading on R, Data.Frames and probably write another blog post as an aide-de-memoire on writing & publishing a blog post using this configuration that I have. Once that is done, I will contact the original author ([Alison Presmanes Hill](https://twitter.com/apreshill)) of the [method](https://alison.rbind.io/blog/2020-12-new-year-new-blogdown/) I am using, and ask if she would like to include it into her original post.
